...
<template>
  <AuthCard title="Create your account" subtitle="Start capturing webhooks in seconds — free forever.">
    <UButton
      block
    ...
    <UButton block to="/auth/verify-email" class="rounded-[10px] bg-gradient-to-r from-brand-500 to-violet-500 py-3 text-[15px] font-semibold">
      Create account
    </UButton>
